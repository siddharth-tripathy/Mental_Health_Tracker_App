...
public class DDoctorPatientchat extends AppCompatActivity {

    ImageView DoctorPatientChatBackBtn, profile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_d_doctor_patientchat);
        ...
        String Url = bundle.getString("ProfileUrl");
        ...
        Glide.with(DDoctorPatientchat.this)
                .load(Url)
        ...
        messagesAdapter = new MessagesAdapter(DDoctorPatientchat.this, messagesArrayList);
