...
public class AdapterAppointmentHistory extends RecyclerView.Adapter<AdapterAppointmentHistory.MyViewHolder> {

    Context context;
    ArrayList<ModelPayment> modelPayment;
    FirebaseFirestore db = FirebaseFirestore.getInstance();

    public AdapterAppointmentHistory(Context context, ArrayList<ModelPayment> modelPayment) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new AdapterAppointmentHistory.MyViewHolder(v);
    }
